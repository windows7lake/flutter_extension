...
import 'package:flutter_extension/ext/log_ext.dart';
import 'package:flutter_extension/ext/toast_ext.dart';
...
//            return "PROXY 192.168.2.88:8888";
//
//            ///不设置代理
////          return 'DIRECT';
//          };
  ...
  Future<bool> _request(
    ...
    try {
      switch (method) {
        ...
        case POST:
          if (newParams != null && newParams.isNotEmpty) {
            //_client.options.contentType = "application/x-www-form-urlencoded";
